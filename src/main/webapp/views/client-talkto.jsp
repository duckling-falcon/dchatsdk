...
<h1 style="width:500px; margin:50px auto 0; font-size:24px; text-align:center; font-family:Arial,'微软雅黑';color:#666; font-weight:normal">科信（dChat） - 在线服务</h1>
...
<H1 style="font-size:16px; color:#666; font-family:Arial,'微软雅黑';font-weight:normal; margin-bottom:20px;">点击下面按钮发起会话....</H1>
<p>
<a id="rtp_cmd_btn" 
	rtp_userto="${account}"
	rtp_link_uri="rooyee:${talkToLink}"
